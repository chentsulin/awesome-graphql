...
* [Apollo Server Graphql Boilerplate](https://github.com/Cotabox/apollo-server-graphql-boilerplate) - A Node.js boilerplate with Apollo Server 2, Authentication and Mongodb setup.
