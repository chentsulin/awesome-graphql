...
* [Intuitive GraphQL Resolver Example](https://github.com/xpepermint/graphql-example) - Application example using [contextable.js](https://github.com/xpepermint/contextablejs) as GraphQL rootValue on steroids (nested schema, input validation, context-aware models, database implementation, project structure and more).
