...
* [Apollo Server Boilerplate - GraphQL](https://github.com/Kaakati/Apollo-Server-Boilerplate) - A boilerplate to get you up and running with your GraphQL Server with support for MongoDB, it includes a User module to help you proceed with Authorization.
