...
* [Stencil-Apollo](https://github.com/ardatan/stencil-apollo) - A set of Web Components based on [Apollo Client](https://github.com/apollographql/apollo-client) built with [Stencil](https://github.com/ionic-team/stencil)
...
* [Apollo Client documentation](http://www.apollographql.com/react/) - Documentation and example for building GraphQL apps using apollo client
